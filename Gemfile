...
group :jekyll_plugins do
    ...
    gem 'classifier-reborn', '~> 2.4'
    gem 'jekyll', '~> 3.9'
    gem 'jekyll-archives', '~> 2.2'
    gem 'jekyll-diagrams', '~> 0.13'
    gem 'jekyll-email-protect', '~> 1.1'
    gem 'jekyll-feed', '~> 0.15'
    gem 'jekyll-get-json', '~> 1.0'
    gem 'jekyll-imagemagick', '~> 1.2'
    gem 'jekyll-jupyter-notebook', '~> 1.4'
    ...
    gem 'jekyll-toc', '~> 0.18'
    gem 'jekyll-twitter-plugin', '~> 4.0'
    gem 'jemoji', '~> 0.13'
    gem 'loofah', '~> 2.21'
    # gem 'mini_racer'
    gem 'unicode_utils', '~> 1.5'
    gem 'webrick', '~> 1.8'
end
